...
cheerfully taken from
https://github.com/dmishin/tsp-solver/blob/master/tsp_solver/greedy_numpy.py
"""
...
#https://raw.githubusercontent.com/dmishin/tsp-solver/master/tsp_solver/greedy.py
